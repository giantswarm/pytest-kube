# -*- coding: utf-8 -*-
#
# pytest-kube-provider documentation build configuration file, created by
...
project = u'pytest-kube-provider'
copyright = u'2015, Łukasz Piątkowski'
author = u'Łukasz Piątkowski'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-kube-provider Documentation',
     [author], 1)
]
